...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference("Connection.count") do
      post connections_url, params: { connection: { title: @connection.title, unit: @connection.unit } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { title: @connection.title, unit: @connection.unit } }
