...
class TechnicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technical" do
    assert_difference("Technical.count") do
      post technicals_url, params: { technical: { title: @technical.title, value: @technical.value } }
    end
  ...
  test "should update technical" do
    patch technical_url(@technical), params: { technical: { title: @technical.title, value: @technical.value } }
